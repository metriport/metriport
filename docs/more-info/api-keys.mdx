...
On the [Metriport Developer Dashboard](https://dash.metriport.com/settings), we support generating 2 types of API keys - a Secret Key and a Client Key.
...
<Info>
  ...
  Health implementation](/more-info/apple-health).
</Info>
