...
1. Set this endpoint URL on the [settings page](https://dash.metriport.com/settings) in the developer dashboard;
...
Validate requests to your public endpoing by comparing the webhook key with each request's HTTP header.

The webhook key is accessible on [settings page](https://dash.metriport.com/settings) in the developer 
