...
<Expandable title="CSV columns">
  ...
  <ParamField body="cohort1" type="string">
    The name or uuid of a cohort you would like this patient to be added to. See [Working With Cohorts](/medical-api/handling-data/working-with-cohorts/) for more info.
  </ParamField>
  
  <ParamField body="cohort2" type="string">
    The name or uuid of a cohort you would like this patient to be added to. See [Working With Cohorts](/medical-api/handling-data/working-with-cohorts/) for more info.
  </ParamField>
</Expandable>
