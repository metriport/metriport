...
description: "Returns a paginated list of all patients that are members of the specified cohort. Click for additional information on [Cohorts](/medical-api/handling-data/cohorts)"
