...
<BodyField name="cxConsolidatedRequestMetadata" type="object" optional>
  An object that can contain a `meta` field, which is a record of string key-value pairs. This metadata will be returned in the webhook response.
</BodyField>

<BodyField name="cxConsolidatedRequestMetadata.meta" type="object" optional>
  A record of string key-value pairs. Each key and value should be a string with a minimum length of 1 and a maximum length of 40 characters.
</BodyField>
