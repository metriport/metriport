...
<ResponseField name="resources" type="Record" required>
  Object containing resource types as properties and the amount of entries for the resource as value
  (number). Only resource types with amount of entries higher than one are included.
</ResponseField>
