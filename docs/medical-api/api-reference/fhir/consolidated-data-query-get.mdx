...
This endpoint only returns the status of a consolidated data query. To trigger a new query you can
...
const status = await metriport.getConsolidatedQueryStatus(
  patientId,
