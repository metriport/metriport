...
<Tip>
  For patients with a large volume documents, you can use the [Bulk Get Document URL](/medical-api/api-reference/document/bulk-get-document-url) to get all download URLs, instead of doing it one at a time.
</Tip>
