...
<ParamField query="organization" type="string" optional>
  The name of the contained Organization to filter document references. Partial match and case
  insentitive. If not provided, no Organization filter will be applied.
</ParamField>

<ParamField query="practitioner" type="string" optional>
  The name of the contained Practitioner to filter document references. Partial match and case
  insentitive. If not provided, no Practitioner filter will be applied.
</ParamField>
