    ...
    <ParamField body="type" type="CodeableConcept" required>
      ...
      <Expandable title="Type properties">
        ...
        <ParamField body="coding" type="Coding[]">
          A [Coding](/medical-api/fhir/data-types/coding) property, which is a reference to a code defined by a terminology system (such as [LOINC](https://loinc.org/)) - for example `{ code: "100556-0", system: "http://loinc.org" },`
        </ParamField>
      </Expandable>
    </ParamField>
