          ...
          An object containing optional fields to specify the type of the facility. We ask that you simply provide the name of the facility under the `text` field - see example below.
            <Expandable title="Facility type properties">
              <ParamField body="text" type="string">
                Plain text with the facility name and type - for example `John Snow Clinic - Primary Care Centre`
              </ParamField>
            </Expandable>
        </ParamField>
      </Expandable>
...
// Upload the document using this presignedUrl in a PUT request, something along these lines:
