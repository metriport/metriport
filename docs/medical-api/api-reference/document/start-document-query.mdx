...
Note that the webhook resulting from this query **does not** return all of the available documents for a patient - only what was retrieved with this current query.

<Snippet file="document-query-complete-tip.mdx" />
