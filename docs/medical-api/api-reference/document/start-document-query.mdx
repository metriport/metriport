...
<ParamField query="forcePatientDiscovery" type="string">
  Whether to run patient discovery before running the documnet query. If patient discovery is 
  already running, this parameter will be ignored.
</ParamField>
