...
- monitor the status of the query using the [Get Consolidated Data Query Status endpoint](#/medical-api/api-reference/fhir/consolidated-data-query-get).

- download the Medical Record Summary in a PDF or HTML format using the [Get Medical Record Summary endpoint](/medical-api/api-reference/fhir/get-medical-record-summary.mdx).
