...
To learn more on how to query for a Patient's resources please see the [Get Patient's Consolidated Data](/medical-api/api-reference/fhir/get-patient-consolidated) endpoint.
<<<<<<< HEAD

We also provide the ability to add any FHIR resources to a Patient with our [Add Patient Data
Query](/medical-api/api-reference/fhir/add-patient-data) endpoint.
=======
>>>>>>> master

We also provide the ability to add any FHIR resources to a Patient with our [Create Patient's Consolidated Data
Query](/medical-api/api-reference/fhir/create-patient-consolidated) endpoint.
