...
<Info>
  Pro-tip: you can use our handy [npm package](https://www.npmjs.com/package/@metriport/api) on your server
  if you're using Node:

```typescript
import { MetriportMedicalApi } from "@metriport/api";

const metriportClient = new MetriportMedicalApi("YOUR_API_KEY", options);
```
