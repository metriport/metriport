...
To learn more on how to query for a Patient's resources please see the [Get Patient's Consolidated 
Data](/medical-api/api-reference/fhir/get-patient-consolidated) endpoint.
