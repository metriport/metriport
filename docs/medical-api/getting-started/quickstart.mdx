...
- check when the Medical Record Summary was created in either PDF or HTML format using the [Get Medical Record Summary Info](/medical-api/api-reference/fhir/get-medical-record-summary-info) endpoint.
