...
As a healthcare organization, you will surely be creating your own medical documents for your patients.
It is vital for patients' best health outcomes that these documents are also uploaded to the networks, so they can be accessed by other players in the field.

To upload your newly-created documents, you can use the [Upload Document endpoint](/medical-api/api-reference/document/post-upload-url).
