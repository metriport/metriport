...
Query](/medical-api/api-reference/fhir/get-patient-consolidated) endpoint.
...
<Tip>
  If you're wondering what FHIR is in the first place, or how Metriport makes use of FHIR, you can
  scope out our [FHIR Overview guide](/medical-api/fhir/overview).
</Tip>
