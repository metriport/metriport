...
- **`monitoring.adt`**  
  ...
  To force-enable for a specific state HIE (see list of supported state HIEs [here](/medical-api/handling-data/cohorts#list-of-state-hies)) instead of using the [primary address state](/medical-api/api-reference/patient/create-patient#param-is-primary), simply input the name of the HIE(s) in an array.
