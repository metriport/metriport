...
- LOW RISK ( 🟢 ): monthly medical record refresh - MEDIUM RISK
( 🟡 ): monthly medical record refresh & prescription medication
history - HIGH RISK ( 🔴 ): **weekly medical record refresh**,
and monitoring enabled for all available sources{" "}
