...
**Patient Monitoring** provides real-time visibility into your patients' healthcare journey across multiple facilities and systems. Through instant notifications and comprehensive tracking, you can proactively manage patient care and improve outcomes.
...
The core of Patient Monitoring is realtime patient notifications - webhook-based alerts that provide immediate updates about your patients' healthcare events. These notifications include administrative and clinical data and enable you to build automated workflows around patient care. Learn more about these [here](/medical-api/handling-data/realtime-patient-monitoring).
...
Patient Monitoring is enabled through **cohorts** - named collections of patients that share common characteristics or care requirements. Cohorts allow you to apply monitoring rules at scale and organize patients for targeted care management. Follow [this link](/medical-api/handling-data/cohort) to learn more about cohorts.
