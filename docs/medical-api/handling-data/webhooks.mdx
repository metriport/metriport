...
- `patient.admit`: signals the official start of a patient’s stay in a healthcare facility.
- `patient.transfer`: indicates that a patient has been moved from one location to another within a healthcare system.
- `patient.discharge`: indicates the end of a patient’s stay in a healthcare facility.
