...
# Overview
Scheduled Queries is an automated and scheduled version of adhoc queries (e.g., [Start Document Query](/medical-api/api-reference/document/start-document-query)).
...
Use this feature by [setting it up in one or more Cohorts](/medical-api/handling-data/cohorts) and associating the patients you want to have enabled for each schedule.
