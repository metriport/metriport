...
Update a patient’s network opt‑out status programmatically. For full details, see the [HIE Opt‑Out API reference](http://localhost:3001/medical-api/api-reference/patient/hie-opt-out).
