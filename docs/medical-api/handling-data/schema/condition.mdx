...
**Normalization Note:**
Normalization of coding systems only occurs when the coding system is one of: ICD-10-CM, SNOMED CT, ICD-9-CM, or LOINC. Other coding systems will not be normalized.
