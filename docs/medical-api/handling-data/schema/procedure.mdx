...
| start_date | date | Start date of the procedure | - |
...
| normalized_code_type | string | Type of normalized coding system | CPT, LOINC, SNOMED CT, or HCPCS |
| normalized_code | string | Standardized/normalized code | CPT, LOINC, SNOMED CT, or HCPCS |
| normalized_description | string | Human-readable description of normalized code | CPT, LOINC, SNOMED CT, or HCPCS |
