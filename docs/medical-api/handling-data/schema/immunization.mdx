...
**Normalization Note:**
This table does not include normalized coding fields as immunizations use different coding systems that are not normalized in the current implementation.
