...
- [MedicationRequst](/medical-api/fhir/resources/medicationrequest): an order or request for both supply of the medication and the instructions for administration of the medication to a patient.
