...
You can pass metadata to the [start document query](/medical-api/api-reference/document/start-document-query), [start consolidated data query](/medical-api/api-reference/fhir/consolidated-data-query-post), or [start bulk get document url](/medical-api/api-reference/document/download-url-bulk)
