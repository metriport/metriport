...
<Info>
Other Identity Providers (IDP) might have different steps, so don't refer to numbered steps unless talking specifically about Google (or in case you're familiar with the respective IDP's flow).
</Info>
...
When they open the link, they'll see this page, where they should choose the SAML provider:
