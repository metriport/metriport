...
- All Patient references must point to the Metriport patient ID the data is being uploaded for. In this example, it's `subject.reference` in the Encounter resource.
