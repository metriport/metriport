...
2. When the file is rendered, a [webhook message with a downloadable URL](/medical-api/more-info/webhooks#medical-record) will be sent to you.
...
2. Select whether you want to download a new or a previously-generated (if such is available) Medical Record Summary
3. Click the button with the desired format to initiate the download.
