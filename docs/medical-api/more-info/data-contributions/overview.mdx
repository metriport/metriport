...
The `identifier` is optional and you can use it to tie the resource back to how it may be stored in your system. For example, you might be storing a patient's information under the ID `1234abcd`. This can be whatever number or string your system uses. But this is not a UUID, and we cannot use these to refer to resources uniquely. Therefore, these identifiers are optional, and are there for your convenience.
...
- The Composition resource should have adequate collection of resources to construct a meaningful document.

For examples of how to construct Progress Notes, Discharge Summaries, etc follow [this link](/medical-api/more-info/data-contributions/composition).
