...
The SDK is available as an NPM package and you can access it [here](https://www.npmjs.com/package/@metriport/api).
...
[here](https://github.com/metriport/metriport/blob/develop/packages/packages/api/src/medical/client/metriport.ts).