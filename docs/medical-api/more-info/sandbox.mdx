...
The Sandbox envirnmont will give you access to comprehensive example clinical data for several
...
<Tip>
  You can expect about 15 example documents per Patient, roughtly breaking down to: 10 C-CDA XMLs
  (and the resulting FHIR resources), 3 PDFs, and 2 images.
</Tip>
