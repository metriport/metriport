...
<Info>
  This Secret Key will allow you to start making requests to the entire
  Metriport API on your behalf. Treat this like a password, and keep it
  somewhere safe! You can read the [API Keys](/more-info/api-keys) page to learn
  more about API key security best practices.
</Info>
...
<Info>
  ...
  URL. For example: ```typescript `https://connect.metriport.com/?token=$
