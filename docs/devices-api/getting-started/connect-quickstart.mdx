...
const metriportClient = new MetriportDevicesApi("YOUR_API_KEY", "ENVIRONMENT_URL");
```
...
Head to the [webhook page](/devices-api/more-info/webhooks) to learn how to setup this integration with Metriport.
