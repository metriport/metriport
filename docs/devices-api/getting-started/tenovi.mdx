...
the SDK will automatically send it to the Metriport API, and we'll forward it to your webhook URL.
...
To connect to Tenovi, you will need to obtain a [connect token](/devices-api/api-reference/user/create-connect-token), and use the [Connect RPM Provider](/devices-api/api-reference/connect/connect-provider) endpoint.
