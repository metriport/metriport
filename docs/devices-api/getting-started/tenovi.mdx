...
To connect to Tenovi, you will need to obtain a [connect token](/devices-api/api-reference/user/create-connect-token), and use the [Connect Provider](/devices-api/api-reference/connect/connect-provider) endpoint.
