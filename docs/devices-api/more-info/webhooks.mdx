...
When using the Devices API, Metriport will send Webhook messages containing [new provider connections](#user-provider-connection-message) for each user, as well as [user data](#user-health-data-message) to your app from [our supported Providers](/devices-api/more-info/our-integrations), as soon as the data becomes available.
...
## User provider connection message
