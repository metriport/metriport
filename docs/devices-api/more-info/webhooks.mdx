...
When using the Devices API, Metriport will send Webhook messages containing [new provider connections](#provider-connected-message) for each user, as well as [user data](#user-health-data-message) to your app from [our supported Providers](/devices-api/more-info/our-integrations), as soon as the data becomes available.
...
<ResponseField name="meta" required>
  ...
  <Expandable title="meta type property details">
    ...
    <ResponseField name="type" type="DAPIWebhookType" required>
      The type of the Devices API webhook data message. Example: `devices.provider-connected`.
    </ResponseField>
...
<ResponseField name="users" required>
  ...
  <Expandable title="users properties">
    ...
    <ResponseField name="provider" type="string" required>
      A string representing the newly-connected provider for the user.
    </ResponseField>
...
<ResponseField name="meta" required>
  ...
  <Expandable title="meta type property details">
    ...
    <ResponseField name="type" type="DAPIWebhookType" required>
      The type of the Devices API webhook data message. Example: `devices.health-data`.
    </ResponseField>
