---
title: "Cordova"
description: "A plugin to integrate with Metriport on Cordova - including Apple Health integrations."
---

<Info>
  Before getting started, visit the [Apple Health
...
To use our SDK go to your index.html add:
