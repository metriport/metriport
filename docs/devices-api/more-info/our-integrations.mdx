...
<Warning>
  ...
  There are known issues where if you connected one user to an account and then later connect
  another user to that same provider account the previous user's tokens will be revoked.
</Warning>
