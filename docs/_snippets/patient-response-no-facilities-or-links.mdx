...
<ResponseField name="indentifiers" type="Indentifier" optional>
  A map the containing external identifiers. If the patient is created in Metriport through one of 
  ...
  <Expandable title="Indentifier properties">
    <ResponseField name="athena" type="string">
      Athena patient ID.
    </ResponseField>
