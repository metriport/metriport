...
<Info>
  ...
  involving the Patient. It will also be included within the webhook payloads. If the patient has been mapped
  to a patients in third party EHRs, Metriport will automatically map those into the patient.
</Info>
