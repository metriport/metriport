...
<ParamField body="address" type="Address[]" required>
  ...
  <Info>
    ...
    You can change which address is the primary address by simply re-ordering the address array using the [PUT patient](/medical-api/api-reference/patient/update-patient) endpoint. 
    Learn more about [patient monitoring](/medical-api/handling-data/patient-monitoring) 
    and [cohorts](/medical-api/handling-data/cohorts).
  </Info>
</ParamField>
