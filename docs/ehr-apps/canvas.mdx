...
Metriport's Canvas app enables seamless access to patient health data directly within the Canvas EHR workflow through an modal application in the patient's Chart. The modal app provides access to all health data available via Metriport's dashboard and API, including the ability to initiate new Document Queries.
...
2. Canvas customer success will install and set up the Metriport app within your instance.
