import { CommonWell, getId, getIdTrailingSlash, getPersonIdFromSearchByPatientDemo, RequestMetadata } from "@metriport/commonwell-sdk";
...
export async function findOrCreatePerson(
    ...
    patientData: typeof docPerson | typeof patient
