/* ============================================================
   ...
   Purpose
     ...
     against sex-specific 99th percentile thresholds (URLs).
   ============================================================ */
...
/* RAW: patient attributes limited to the troponin cohort */
patient_sex_raw AS (
  SELECT
    p.PATIENT_ID,
    CASE
...
/* -------------------------
   CLEAN: keep plausible, canonicalized rows; drop unknown sex; exclude dx
   ------------------------- */
troponin_clean AS (
  SELECT
    n.*,
