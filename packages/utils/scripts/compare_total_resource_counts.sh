#!/bin/bash
## This script pulls the total resource count reference file from s3 and compares it to the file passed in as an argument.
...
S3_FILE2="s3://fhir-resource-count/develop-fhir-resource-count.json"
