...
def transform_and_upload_data(
    ...
    output_file_keys_and_table_names = []
    for file in set(local_output_files):
        ...
        output_file_keys_and_table_names.append((output_file_key, table_name))

    return output_file_keys_and_table_names
...
if __name__ == "__main__":
    ...
    output_file_keys_and_table_names = transform_and_upload_data(
        input_bucket,
        output_bucket,
        api_url,
        job_id,
    ...
    for output_file_key, table_name in output_file_keys_and_table_names:
