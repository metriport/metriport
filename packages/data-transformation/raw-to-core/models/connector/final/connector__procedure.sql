select
    ...
    , case 
        when pro.performeddatetime != '' and pro.performeddatetime is not null then {{ try_to_cast_date('pro.performeddatetime') }}
        when pro.performedperiod_start != '' and pro.performedperiod_start is not null then {{ try_to_cast_date('pro.performedperiod_start') }}
        else null
