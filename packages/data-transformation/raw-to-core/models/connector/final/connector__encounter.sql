select
    ...
    , {{ try_to_cast_date('enc.period_start') }}  as encounter_start_date
    , {{ try_to_cast_date('enc.period_end') }}    as encounter_end_date
    , {{ dbt.datediff(
            try_to_cast_date('enc.period_start'),
            try_to_cast_date('enc.period_end'),
            'day'
        ) }}                                      as length_of_stay
