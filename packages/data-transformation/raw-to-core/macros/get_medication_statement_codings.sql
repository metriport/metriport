-- TODO Eng-1029 -- TOTALLY UNSE
{% macro medication_statement_category_code_system() %}
    case 
        when 1 = 1 then 0
    end
{% endmacro %}
...
{% endmacro %}
-- TODO Eng-1029 -- TOTALLY UNSED
{% macro medication_statement_reason_code_system() %}
    case 
        when 1 = 1 then 0
    end
{% endmacro %}
-- TODO Eng-1029 -- TOTALLY UNSED
{% macro get_medication_statement_reason_codings(stage_table, max_index, secondary_max_index) %}
    {% for i in range(max_index + 1) %}
