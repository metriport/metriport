  ...
  implements BaseBedrockInput
{
  ...
  override get lc_attributes(): SerializedFields | undefined {
    return { region: this.region };
  }

  override _identifyingParams(): Record<string, string> {
    return {
      model: this.model,
    };
  }
  ...
  constructor(fields?: BedrockChatFields) {
    ...
    fields = {
      ...
      ...(awsSessionToken !== undefined ? { awsSessionToken } : {}),
    };
  ...
  override getLsParams(options: this["ParsedCallOptions"]): LangSmithParams {
    ...
    return {
      ...
      ls_model_type: "chat",
      ...(params.temperature !== undefined ? { ls_temperature: params.temperature } : {}),
      ...(params.max_tokens !== undefined ? { ls_max_tokens: params.max_tokens } : {}),
      ...(options.stop !== undefined ? { ls_stop: options.stop } : {}),
    };
  }
