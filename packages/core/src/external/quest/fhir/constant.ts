...
export const QUEST_STANDARD_ORDER_CODE_URL = "http://questdiagnostics.com/standard-order-code";
export const QUEST_REQUISITION_NUMBER_URL = "http://questdiagnostics.com/requisition-number";
