...
describe("PsvToHl7Converter", () => {
  beforeAll(() => {
    ...
    jest.useFakeTimers();
    jest.setSystemTime(buildDayjs("2024-01-15T12:00:00-06:00").toDate());
  });
