...
import { CxMapping, CxMappingParams, CxMappingSource } from "../../domain/cx-mapping";
...
export async function getCxMappings({ source }: { source: CxMappingSource }): Promise<CxMapping[]> {
