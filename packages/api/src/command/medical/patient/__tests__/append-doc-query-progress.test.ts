...
import { setDocQueryProgressWithSource } from "../../../../external/hie/set-doc-query-progress-with-source";
...
beforeEach(() => {
  ...
  jest.spyOn(webhooks, "handleWebhookBeingSent").mockImplementation();
