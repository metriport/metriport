...
import { startFhirToCsvTransform } from "@metriport/core/command/analytics-platform/fhir-to-csv/command/fhir-to-csv-transform";
...
/**
 * POST /internal/analytics-platform/fhir-to-csv/transform
 *
 * Runs the fhir to csv job.
 * @param req.query.cxId - The CX ID.
 * @param req.query.jobId - The job ID.
