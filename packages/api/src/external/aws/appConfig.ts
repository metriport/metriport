import { getFeatureFlagValue, FFStructure } from "@metriport/core/external/aws/appConfig";
 ...
 */
async function getCxsWithFeatureFlagValue(featureFlagName: keyof FFStructure): Promise<string[]> {
  try {
