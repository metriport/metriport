...
import TouchWorksApi, { TouchWorksEnv } from "@metriport/core/external/ehr/touchworks/index";
...
type EhrEnv = AthenaEnv | ElationEnv | CanvasEnv | HealthieEnv | EClinicalWorksEnv | TouchWorksEnv;
