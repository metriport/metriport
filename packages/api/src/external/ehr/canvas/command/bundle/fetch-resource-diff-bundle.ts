...
/**
 * Fetches the precomputed bundle of resources that are in Metriport and not in Canvas, or vice versa.
 ...
 * @returns The bundle of resources. If a resource type bundle is not found, it is not included in the bundle.
 */
