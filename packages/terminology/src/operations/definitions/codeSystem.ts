...
export const loinc: CodeSystem = {
  ...
  property: [
    ...
    },
    {
      ...
      description:
        "First major axis-component or analyte: Analyte Name, Analyte sub-class, Challenge",
      type: "Coding",
    },
    {
      code: "PROPERTY",
      ...
      description:
        "Second major axis-property observed: Kind of Property (also called kind of quantity)",
      type: "Coding",
    },
    {
      code: "TIME_ASPCT",
    ...
    },
    {
      ...
      description:
        "An arbitrary classification of terms for grouping related observations together",
      type: "Coding",
    },
    {
    ...
    },
    {
      ...
      description:
        "An answer list associated with this LOINC code (if there are matching answer lists defined).",
      type: "Coding",
    },
    {
      code: "MAP_TO",
      ...
      description:
        "A replacement term that is to be used in place of the deprecated or discouraged term.",
      type: "Coding",
    },
    {
      code: "analyte",
      ...
      description:
        "First sub-part of the Component, i.e., the part of the Component before the first carat",
      type: "Coding",
    },
    {
      code: "analyte-core",
    ...
    },
    {
      ...
      description:
        "The divisor part of the analyte, if present, i.e., after the slash and before the first carat",
      type: "Coding",
    },
    {
    ...
    },
    {
      ...
      description:
        "Radiology exam Laterality is specified as one of: Left, Right, Bilateral, Unilateral, Unspecified",
      type: "Coding",
    },
    {
    ...
    },
    {
      ...
      description:
        "Guidance for.Action indicates the intervention performed, such as biopsy, aspiration, or ablation.",
      type: "Coding",
    },
    {
      ...
      description:
        "Guidance for.Object specifies the target of the action, such as mass, abscess or cyst.",
      type: "Coding",
    },
    {
      code: "rad-subject",
...
export const cpt: CodeSystem = {
  ...
  property: [
    ...
    },
    {
      ...
      description:
        "Additional explanatory text that is applicable to a concept (code/heading/subheading).",
      type: "string",
    },
    {
      code: "SPECIALTY",
