...
export * from "./domain/address/geo";
...
export * from "./domain/contact/index";
export * from "./domain/contact/phone";
export * from "./domain/identifier/index";
export * from "./domain/identifier/ssn";
...
export * from "./domain/patient/demographics";
