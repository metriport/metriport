import { buildLexicalIdGenerator, getTimestampFromId } from "../lexical-id";
...
describe("ID Generator", () => {
  ...
  it("should generate an ID of the correct length", () => {
    const idGenerator = buildLexicalIdGenerator(10);
