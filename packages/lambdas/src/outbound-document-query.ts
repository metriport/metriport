import { pollOutboundDQResults } from "@metriport/core/external/carequality/command/documents/send-ihe-gateway-results";
...
export const handler = Sentry.AWSLambda.wrapHandler(
  async ({
    ...
    try {
      const results = await pollOutboundDQResults({
        requestId,
        patientId,
        cxId,
        numOfGateways,
