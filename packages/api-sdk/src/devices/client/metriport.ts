...
export class MetriportDevicesApi {
   ...
   * @param {string} deviceIds - A comma-separated list of device IDs to connect to the user. Required for Tenovi.
   * @param {string} deviceUserId - The user ID (patient ID, with some providers) of the user that is connected to the device. Required for Tenovi.
   */
