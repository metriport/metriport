...
public final class Body implements IMetriportData {
  ...
  private Body(Metadata metadata, Optional<Double> bodyFatPct, Optional<Double> heightCm,
      ...
      Optional<List<Sample>> weightSamplesKg, Map<String, Object> additionalProperties) {
  ...
  public static final class Builder implements MetadataStage, _FinalStage {
    ...
    @Override
    public Body build() {
      return new Body(metadata, bodyFatPct, heightCm, weightKg, boneMassKg, muscleMassKg, leanMassKg, maxPossibleHeartRateBpm, weightSamplesKg, additionalProperties);
    }
  }
}
