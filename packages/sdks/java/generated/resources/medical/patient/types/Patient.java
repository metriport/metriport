...
public final class Patient implements IBasePatient {
  ...
  private Patient(String firstName, String lastName, String dob, String genderAtBirth,
      Optional<List<PersonalIdentifier>> personalIdentifiers, Optional<Addresses> address,
      Optional<Contacts> contact, String id, Map<String, Object> additionalProperties) {
  ...
  private boolean equalTo(Patient other) {
    return firstName.equals(other.firstName) && lastName.equals(other.lastName) && dob.equals(other.dob) && genderAtBirth.equals(other.genderAtBirth) && personalIdentifiers.equals(other.personalIdentifiers) && address.equals(other.address) && contact.equals(other.contact) && id.equals(other.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.firstName, this.lastName, this.dob, this.genderAtBirth, this.personalIdentifiers, this.address, this.contact, this.id);
  }
  ...
  public static final class Builder implements FirstNameStage, LastNameStage, DobStage, GenderAtBirthStage, IdStage, _FinalStage {
    ...
    public Patient build() {
      return new Patient(firstName, lastName, dob, genderAtBirth, personalIdentifiers, address, contact, id, additionalProperties);
    }
  }
}
