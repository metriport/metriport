...
export const SleepBiometrics: core.serialization.ObjectSchema<
    serializers.devices.SleepBiometrics.Raw,
    Metriport.devices.SleepBiometrics
> = core.serialization.object({
    ...
    temperature: core.serialization.lazyObject(async () => (await import("../../..")).devices.Temperature).optional(),
});

export declare namespace SleepBiometrics {
    interface Raw {
        ...
        temperature?: serializers.devices.Temperature.Raw | null;
    }
}
