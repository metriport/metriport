...
export class IHEStack extends Stack {
  constructor(scope: Construct, id: string, props: IHEStackProps) {
    ...
    // const vpc =
    ec2.Vpc.fromLookup(this, "APIVpc", { vpcId });

    // const alarmSnsAction =
    setupSlackNotifSnsTopic(this, props.config);
    ...
    // const certificate =
    cert.Certificate.fromCertificateArn(this, "IHECertificate", props.config.iheGateway.certArn);
