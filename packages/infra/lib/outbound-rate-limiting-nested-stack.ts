...
interface OutboundRateLimitingNestedStackProps extends NestedStackProps {
  config: EnvConfig;
  alarmAction?: SnsAction;
}

function getSettings(props: OutboundRateLimitingNestedStackProps) {
  return {
    ...props,
...
export class OutboundRateLimitingNestedStack extends NestedStack {
  readonly outboundRateLimitTable: dynamodb.Table;

  constructor(scope: Construct, id: string, props: OutboundRateLimitingNestedStackProps) {
