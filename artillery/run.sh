...
# artillery run --output report_existing_upsert.json artillery-existing-upsert.yml
# artillery report report_existing_upsert.json 
# sleep 2
...
artillery run --output report_new_upsert.json artillery-new-upsert.yml
artillery report report_new_upsert.json 
sleep 5
