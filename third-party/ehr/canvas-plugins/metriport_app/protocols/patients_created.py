...
class PatientCreatedProtocol(BaseProtocol):
    """A protocol that sends a webhook to the Metriport API when a patient is created."""

    RESPONDS_TO = EventType.Name(EventType.PATIENT_CREATED)

    def compute(self):
        """Send a request to the Metriport API when a patient is created to create a patient in Metriport."""
