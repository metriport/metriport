...
export const mapToActivity = (
  activities: GarminActivityDetail[]
): UserData<Activity>[] => {
  const type = "activity";
...
export const garminActivityDetailListSchema = z.array(
  garminActivityDetailSchema
);
export type GarminActivityDetailList = z.infer<
  typeof garminActivityDetailListSchema
>;
