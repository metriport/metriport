...
function setSearchParamterDetails(
  resourceType: string,
  code: string,
...
function getSearchParameterType(
  searchParam: SearchParameter,
...
export function getExpressionForResourceType(
  resourceType: string,
  expression: string
): string | undefined {
